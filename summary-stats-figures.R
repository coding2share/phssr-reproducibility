...
#long version #odds ratios data from: https://github.com/coding2share/phssr-reproducibility/blob/master/ReprodicibilityORgraphs-long.csv
...
Reppaper5 <- c(33.0,20.7,16.3,21.6,8.3,13.0,69.3,17.6,70.5,53.3,53.6,55.4,
               55.5,17.2,26.2,61.2,59.5,56.3,12.5,19.2,37.7,15.3,15.4,16.3,20.4,
               17.7,9.9,35.7,27.0,17.0,40.1,44.3,19.7,15.2,16.3,4.5,20.4,73.6,
               6.0,71.7,43.8,53.2,53.2,48.7,12.0,26.1,61.2,55.4,47.3,27.7,
               16.8,35.0,9.7,10.9,24.8,23.3,12.4,8.6,30.1,33.4,13.8,38.9)
...
Reppaper32 <- c(10.5,	21.5,	40.3,	11.2,	20.8,	11.1,	21.8,	11.6,	17.1,	12.4,	8.9,	18.5,
                ...
                83.3,	84.7,	88.3,	72.9,16.7,	34.6,	53.3,	15.7,	25.5,	26.6,	30.4,	15.8,	25.3,	
                ...
                65.4,	46.7,	84.3,	74.5,	73.4,	69.6,	84.2,	74.7,	69.2,	76.9,	74.9,	75.4,	
...
Reppaper1 <- c(38.9,20.8,40.3,76.3,71.1,46.8,76.2,74.0,12.9,79.8,
...
Origpaper12 <- c(4.1,8.9,87.0,100,93.8,89.1,79.1,58.3,18.6,73.5,7.8,
                 ...
                 6.9,26,6.4,5.7)
Reppaper12 <- c(4.1,8.9,87.0,100,97.6,89.1,79.1,58.3,18.6,73.5,7.8,
                62.1,51.6,72.3,0,30.2,40.5,29.3,53.8,40,6.2,0,244204,218140,
                46.7,235.5,6,9.2,41.3,21.6,37.1,74.6,69.0,43.8,76,75.1,12.5,80.2,7.3,
...
sigtable$change2sig <- c(0/15,0/5,0/10,0/16,0/39,1/21,1/21,1/21,0/11,0/15,0/16,3/27,0/30,0/7,0/40)
